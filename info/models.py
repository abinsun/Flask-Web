...
class News(BaseModel, db.Model):
    ...
    count = db.Column(db.Integer, default=0)  # 推荐次数
    shoulu = db.Column(db.Integer, default=0)  # 是否收录
    quanzhong = db.Column(db.Integer, default=0)  # 是否收录
...
class Category(BaseModel, db.Model):
    ...
    dec = db.Column(db.String(128), nullable=False)  # 描述
